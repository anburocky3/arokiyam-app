  ...
  useEffect(() => {
    ...
    void window.api
      ...
      .then((state) => {
        ...
        setUpdateDownloadProgress(state.downloadProgress)
        if (!state.packaged) {
    ...
    const unsubscribeUpdateStatus = window.api.onUpdateStatus((status) => {
      if (!isMounted) return
      setUpdateReady(status.updateReady)
  ...
  const checkForUpdatesNow = (): void => {
    ...
    void window.api
      ...
      .then((result) => {
        ...
        setUpdateDownloadProgress(result.downloadProgress)
        ...
        <section className={`mx-auto mt-8 w-full max-w-6xl p-6 ${panelClass}`}>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <div className={`${cardClass} p-5 md:col-span-2`}>
              ...
              {updateDownloadProgress > 0 && !updateReady && (
                <div className="mt-4">
